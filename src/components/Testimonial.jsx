...
const testimonials = [
          {
              ...
              testimonial: "I've rental cars form form various companies, but the experience with CarRental was exceptional.",
            },
           ...
           { name: "Ava Johnson",
            ...
            image: assets.testimonial_image_1,
            testimonial: "I highly recommed CarRental! Their fleet is amazing and I always fell like I'm getting the best deal with excellent service." },
        ]
                    ...
                    hover:translate-y-1 transition-all duration-500">
                        ...
                        <div className="flex items-center gap-1 mt-4">
                            {Array(5).fill(0).map((_, index) => (
                                <img  key={index}
                                src={assets.star_icon} alt="star-icon" />
